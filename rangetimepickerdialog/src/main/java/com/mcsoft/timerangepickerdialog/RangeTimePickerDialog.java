...
public class RangeTimePickerDialog extends DialogFragment {
    ...
    private String messageErrorRangeTime = "Error: Establezca un hora de finalización mayor que a la hora de inicio";
    private String textBtnPositive = "Ok";
    private String textBtnNegative = "Cancelar";
    private String textTabStart = "Inicio de Trabajo";
    private String textTabEnd = "Fin de Trabajo";
                            ...
                            if (range == 0 || !validateRange) {
                                ...
                                if (checkdiffernce(hourStart, minuteStart, hourEnd, minuteEnd) >= range) {
                                    ...
                                    Toast.makeText(getActivity(),
                                            "Error: el tiempo seleccionado no puede ser inferior a " + range + " minutos.",
